...
const UserInf = (props) => {
  const { ProfileUserFollowerOrFollowing } = useBoundStore(
    (state) => state,
    shallow
  );
  let ethAddress = props.dataObjNft?.attributes?.ethAddress
    ? props.dataObjNft.attributes.ethAddress
    : "";
  return (
    <Card
      sx={{
    ...
    >
      <CardContent>
        ...
        >
          ...
          >
            Following ............ {ProfileUserFollowerOrFollowing?.following}
          </Typography>
          <Typography
            variant="body2"
            sx={{ color: "text.secondary", textAlign: "center" }}
          >
            Followers ............ {ProfileUserFollowerOrFollowing?.followers}
          </Typography>
