...
const CardOwnerCollection = (props) => {
      ...
      <CardContent sx={StyledCardContent}>
        ...
        {props.avatarOwner ? (
          <CardMedia
            ...
            onClick={() => {
              props.directionAddress == contracts.collection
                ? null
                : navigate(`/profile-colletion/${props.directionAddress}`);
            }}
            component="img"
...
export default CardOwnerCollection;
