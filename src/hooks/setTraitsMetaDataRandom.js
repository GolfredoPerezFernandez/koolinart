/**
 * The function `generateNFTMetadata` generates random values for various properties of an NFT metadata
 * object.
 * @returns The function `generateNFTMetadata` returns an object `metadata` with randomly generated
 * values for properties such as `energy`, `force`, `impact`, `sustainability`, `valueNft`, `rarity`,
 * and `type`.
 */
...
/**
 * The `useGenerateNFT` function generates metadata for a non-fungible token (NFT) based on randomly
 * generated values and certain rules.
 * @returns The function `useGenerateNFT` returns a metadata object that contains the randomly
 * generated values for `energy`, `force`, `impact`, `sustainability`, `valueNft`, `rarity`, and
 * `type`.
 */
const useGenerateNFT = async () => {
  try {
    ...
    let mean =
      (energy + force + impact + sustainability + valueNft + rarity) / 6;
